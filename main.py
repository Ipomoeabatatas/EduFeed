...
disclaimer = f"""_By using this website, I understand that the content generated by this website is purely based on imperfect AI technologies, and therefore, the website and its creators cannot take any responsibility for its accuracy or completeness. It is my responsibility to use this tool in a responsible and ethical manner, and to ensure that the generated content is thoroughly reviewed and edited before use. I accept that the website and its creators cannot be held liable for any consequences, and that I must use this tool at my own discretion and risk._"""
...
st.title("Feedback Sensei\n **Giving personalise feedback like a sensei **")
